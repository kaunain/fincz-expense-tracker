...
@Component({
  ...
  template: `
    <div class="settings-page">
      ...
      <!-- ============================================================
           SECTION: Transfer Between Accounts
           Creates 2 linked transactions:
             1. Expense (debit) from the "From" account — category: Transfer
             2. Income (credit) to the "To" account — category: Transfer
           ============================================================ -->
      <div class="m3-card settings-card">
        <div class="card-icon-header">
          <span class="material-symbols-outlined header-icon transfer-icon">swap_horiz</span>
          <div>
            <h3>Transfer Between Accounts</h3>
            <p class="card-desc">
              Move money between Cash, UPI, Bank etc. Creates paired debit & credit entries.
            </p>
          </div>
        </div>
        ...
        <div class="transfer-form">
          ...
          <div class="form-row-2">
            <div class="form-group">
              ...
              <select id="transferFrom" class="select-input" [(ngModel)]="transfer.from">
            ...
            <div class="form-group">
              ...
              <select id="transferTo" class="select-input" [(ngModel)]="transfer.to">
                <option *ngFor="let m of paymentMethods" [value]="m">{{ m }}</option>
              </select>
            </div>
          </div>
...
export class SettingsComponent {
  ...
  /**
   * Records a money transfer between two payment accounts.
   * Creates 2 transactions:
   *   1. Expense — debits the "From" account (category: Transfer)
   *   2. Income  — credits the "To" account   (category: Transfer)
   */
