  ...
  template: `
    <div class="accounts-page">
      ...
      <div class="accounts-grid">
        <div
          *ngFor="let acc of accountService.accountsWithBalances()"
          class="m3-card account-card"
          matRipple
        >
          <div class="acc-top">
            <div class="acc-badge">
              ...
              <span
                class="material-symbols-outlined acc-mat-icon"
                *ngIf="!isEmoji(acc.icon) && acc.icon"
                >{{ acc.icon }}</span
              >
      ...
      <div class="m3-card transfers-section">
        ...
        @if (transfersList().length === 0) {
          <div class="empty-transfers">No account transfers recorded yet.</div>
        } @else {
          <div class="transfer-list">
            @for (t of transfersList(); track t.id) {
